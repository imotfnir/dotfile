...
# mode
set $windows_edit "←↑→↓=resize, | -=split, x=kill, space=fullscreen"
set $move_ws "press num key move windows to workspace<num>"
bindsym $mod+w mode $windows_edit
...
mode $windows_edit {
    ...
    bindsym Shift+backslash split h; mode "default"
    # split in vertical orientation
    bindsym minus split v; mode "default"
    # enter fullscreen mode for the focused container
    bindsym space fullscreen toggle; mode "default"
