...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN1] = LAYOUT_60_ansi(KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_F13,
                         RCS(KC_TAB), LSFT(KC_HOME), LSFT(KC_END), V_WORD, V_LINE, MS_WHLU, MS_LEFT, MS_DOWN, MS_UP, MS_RGHT, KC_TRNS, KC_HOME, KC_END, KC_PSCR,
                         TG(1), KC_HOME, KC_END, KC_DEL, KC_BSPC, MS_WHLD, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_PGUP, KC_PGDN, KC_TRNS,
                         KC_TRNS, KC_TRNS, KC_TRNS, LCTL(KC_C), LCTL(KC_V), KC_TRNS, KC_ENT, MS_BTN3, MS_BTN2, KC_INS, KC_DEL, KC_TRNS,
