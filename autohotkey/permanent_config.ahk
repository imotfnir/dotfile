...
#HotIf MouseIsOver("ahk_class Qt51519QWindowIcon ahk_exe Telegram.exe", "Media viewer")
WheelUp:: Send "{Left}"
...
#HotIf MouseIsOver("ahk_class Qt51517QWindowIcon ahk_exe Telegram.exe")
...
; Edge Browser
#HotIf IsFullScreenInSomeWebsite("(YouTube)|(Gimy)|(MX动漫)|(ANi Open)|(唐人街影院)|(Hanime1.me)|(Pornhub)|(Jable)|(Miss)|(Anime1)|(Twitch)|(AEG)")
WheelUp:: Send "{Left}"
WheelDown:: Send "{Right}"
MButton:: Send "{Esc}"
